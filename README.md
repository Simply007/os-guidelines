...
This template is based on open source guidelines originally developed by me (@Simply007) and my team at [Kontent.ai](https://github.com/kontent-ai/os-guidelines). Content has been generalized and adapted for universal use.
